<section>
    ...
    <hr>
        <div class="card-body">
            ...
            @endif
            <form action="{{ url('admin/banner/update/'.$banner->bannerId) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xl-12">
                        <div class="form-group">
                            <label for="bannerTitle">Judul</label>
                            <input type="text" class="form-control" name="bannerTitle" id="bannerTitle" value="{{ $banner->bannerTitle }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bannerDescription" id="bannerDescription" value="{{ $banner->bannerDescription }}">
